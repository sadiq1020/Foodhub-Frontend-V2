...
export function StatsSection() {
  ...
  return (
    ...
    >
      ...
      <Orb
        className="w-80 h-80 bg-emerald-300/20 dark:bg-emerald-500/5 -top-20 -left-15"
        delay={0}
      />
      <Orb
        className="w-72 h-72 bg-violet-300/20 dark:bg-violet-500/5 -bottom-15 -right-10"
        delay={2}
      />
      <Orb
        className="w-48 h-48 bg-amber-300/15 dark:bg-amber-500/4 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
        delay={4}
      />
